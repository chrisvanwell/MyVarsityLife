...
function getEmployees_success(tx, results) {
    ...
    for (var i=0; i<len; i++) {
		...
		window["item"+i] = '<li class="box">'+
                            '<p style="float:left">No</p>' +
                            '<p style="float:right;">Yes</p>' +
                            '<center><img style="background:#ffffff; padding:18px 18px 18px 18px;border:1px solid #999999; " src="pics/' + employee.picture + '"/></center>' +
                            '</li>';
    
    }
    $('#employeeList').append(item0);
  //  alert("item1: "+item1);
  //  alert("item2: "+item2);
	setTimeout(function(){
		scroll.refresh();
...
function populateDB(tx) {
    ...
    tx.executeSql("INSERT INTO employee (id,firstName,lastName,managerId,title,department,officePhone,cellPhone,email,city,picture) VALUES (12,'Steven','Wells',4,'Software Architect','Engineering','617-000-0012','781-000-0012','swells@fakemail.com','Wits, MA','steven_wells.jpg')");
    tx.executeSql("INSERT INTO employee (id,firstName,lastName,managerId,title,department,officePhone,cellPhone,email,city,picture) VALUES (11,'Amy','Jones',5,'Sales Representative','Sales','617-000-0011','781-000-0011','ajones@fakemail.com','Wits, MA','amy_jones.jpg')");
    tx.executeSql("INSERT INTO employee (id,firstName,lastName,managerId,title,department,officePhone,cellPhone,email,city,picture) VALUES (10,'Kathleen','Byrne',5,'Sales Representative','Sales','617-000-0010','781-000-0010','kbyrne@fakemail.com','WITS, MA','kathleen_byrne.jpg')");
    tx.executeSql("INSERT INTO employee (id,firstName,lastName,managerId,title,department,officePhone,cellPhone,email,city,picture) VALUES (9,'Gary','Donovan',2,'Marketing','Marketing','617-000-0009','781-000-0009','gdonovan@fakemail.com','Wits, MA','gary_donovan.jpg')");
